package angel.campos.crudangel1a
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //1. Mandar a llamar todos los elemetos de la vista
        ...
        btnAgregar.setOnClickListener {
            GlobalScope.launch(Dispatchers.IO){
                ...
                val addProducto = objConexion?.prepareStatement("insert into tbProducto1 values(?, ?, ?)")!!
